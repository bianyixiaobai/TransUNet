...
|---|---|---|---|---|
| 1 (aorta 主动脉) | 0.867 | 0.875 | -0.008 | 8.53 |
| 2 (gallbladder 胆囊) | 0.620 | 0.698 | -0.078 | 26.81 |
| 3 (left kidney 左肾) | 0.802 | 0.841 | -0.039 | 51.08 |
| 4 (right kidney 右肾) | 0.730 | 0.867 | -0.137 | 60.95 |
| 5 (liver 肝) | 0.943 | 0.950 | -0.007 | 22.43 |
| 6 (stomach 胃) | 0.539 | 0.832 | -0.293 | 17.91 |
| 7 (spleen 脾) | 0.864 | 0.918 | -0.054 | 36.08 |
| 8 (pancreas 胰) | 0.764 | 0.776 | -0.012 | 16.74 |
| **平均** | **0.766** | **0.842** | **-0.076** | **30.06** |

> 论文数值来自 Chen et al. 2021 (arXiv:2102.04306)。差距为负表示低于论文，
> 可能原因：PyTorch 2.0 / Python 3.10 环境差异、训练时长、未做滑动窗口推理。
> 重点改进目标：stomach (胃, -0.293) 与 right kidney (右肾, -0.137)。
